...
class ResourceUpdateFragment : BaseFragment<FragmentResourceUpdateBinding>() {
    ...
    private fun startDownload() {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            withContext(Dispatchers.IO) {
                ...
                val fileOutputStream = FileOutputStream(com.nl.component.common.FilePathHelper.getResourceZipPath())
                inputStream.use {
    ...
    private fun unzipFile() {
        val zipFilePath = com.nl.component.common.FilePathHelper.getResourceZipPath()
        val unzipDirectory = com.nl.component.common.FilePathHelper.getResourceDirectory()
